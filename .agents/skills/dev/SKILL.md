---
name: dev
description: Implement the highest-priority unfinished sprint task using strict TDD, security scanning, and test validation.
---

# `/dev` Skill Definition

Custom skill for picking the highest-priority task and implementing it with TDD, security scanning, and browser-based E2E testing.
...
For API route tasks: write integration tests for expected inputs and outputs.
...
- If a test fails, read screenshots to debug visually
...
- If you discover a bug in existing code, note it but do not fix it; create a new task instead.
- Playwright tests must take screenshots.
...
└──────────────┘    └──────┬───────┘           │
                      ...
                      └──────┬───────┘
                             ...
                             ▼
                      ┌──────────────┐
                      │ semgrep scan │─── FINDINGS ──▶ Fix then re-run
                      │ npm audit    │
                      └──────┬───────┘
                             │ CLEAN ✅
                             ▼
