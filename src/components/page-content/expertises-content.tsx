...
export function ExpertisesContent() {
  ...
  return (
    <div className="space-y-14">
      ...
      <FadeIn delay={0.08}>
        <section className="surface-card grid gap-8 overflow-hidden p-6 md:grid-cols-[0.82fr_1.18fr] md:p-8">
          <div className="space-y-5">
            <div className="space-y-2">
              <p className="eyebrow">{copy.parallelismLabel}</p>
              <h2 className="text-3xl leading-tight md:text-5xl">{copy.parallelismTitle}</h2>
            </div>
        ...
        <section className="grid gap-5 md:grid-cols-2">
          ...
          <article className="surface-card space-y-5 p-6 md:p-7">
            <div className="space-y-2">
              ...
              <h2 className="text-3xl leading-tight md:text-4xl">{copy.frameworkTitle}</h2>
            </div>
            <p className="text-sm leading-7 text-[color:var(--muted-ink)] md:text-base">{copy.frameworkBody}</p>
