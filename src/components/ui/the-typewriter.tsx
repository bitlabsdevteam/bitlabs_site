...
// Note: imported from the project's existing `framer-motion` (which re-exports
// the same `motion` / `MotionConfig` / `useReducedMotion` APIs) instead of the
// `motion` package, to avoid duplicating an animation dependency.
