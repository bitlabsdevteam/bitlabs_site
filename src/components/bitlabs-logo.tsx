...
function LogoMark(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <rect x="1" y="1" width="42" height="42" rx="12" className="fill-[color:#edf4f0] stroke-[color:rgba(20,24,23,0.12)]" />
      <path
        ...
        className="stroke-[color:#162423]"
        strokeWidth="3"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <circle cx="31.7" cy="10.8" r="2.7" className="fill-[color:#2f7465]" />
      <circle cx="10.3" cy="33.2" r="2.3" className="fill-[color:#2f7465]" />
      <path d="M24.5 22.5H31.4" className="stroke-[color:#2f7465]" strokeWidth="2.2" strokeLinecap="round" />
    </svg>
  );
}
