          ...
          <div className="flex items-center gap-2">
            {socialLinks.map((social) => (
              <Link
                ...
                className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-border bg-secondary/60 text-muted-foreground transition-colors hover:bg-accent hover:text-accent-foreground"
              >
                {social.icon}
              </Link>
            ))}
